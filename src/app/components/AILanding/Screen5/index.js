    ...
    <SectionContainer>
      ...
      <ContentContainer className={styles.container}>
        <div className={styles.example}>
          ...
          <p>
            То, что раньше приходилось долго и&nbsp;сложно делать в&nbsp;3D&nbsp;и&nbsp;рендерить, снимать,
          ...
          <p>
            <strong>Нейросети&nbsp;&mdash; не&nbsp;панацея,</strong> не&nbsp;нужно перечеркивать все свои навыки
          ...
          <p>
            Теперь<strong> ты&nbsp;сможешь выбирать, когда тебе удобнее и&nbsp;быстрее применить в&nbsp;работе
            нейросети,</strong> когда&nbsp;&mdash; сделать снимок, а&nbsp;когда прибегнуть к&nbsp;помощи 3D.
          </p>
          <p>
            <strong>Это просто альтернативный инструмент, который можно и&nbsp;нужно миксовать с&nbsp;другими.</strong>
          </p>
        </div>
      </ContentContainer>
    </SectionContainer>
